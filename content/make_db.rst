...
Congratulations!  You have now set up a database in SQLite3 that contains two tables.  Stay tuned for  **Part 2 Populating an SQLite Database using Python**, coming soon...  
